...
#### El pañuelo
![Persepolis_MarjaneSatrapi_1-01][Persepolis_MarjaneSatrapi_1-01]{: width="80%"}
...
#### La bicicleta
![Persepolis_MarjaneSatrapi_1-02][Persepolis_MarjaneSatrapi_1-02]{: width="80%"}
...
#### La celda de agua
![Persepolis_MarjaneSatrapi_1-03][Persepolis_MarjaneSatrapi_1-03]{: width="80%"}
...
#### Persépolis
![Persepolis_MarjaneSatrapi_1-04][Persepolis_MarjaneSatrapi_1-04]{: width="80%"}
...
#### La carta
![Persepolis_MarjaneSatrapi_1-05][Persepolis_MarjaneSatrapi_1-05]{: width="80%"}
...
#### La fiesta
![Persepolis_MarjaneSatrapi_1-06][Persepolis_MarjaneSatrapi_1-06]{: width="80%"}
...
#### Los héroes
![Persepolis_MarjaneSatrapi_1-07][Persepolis_MarjaneSatrapi_1-07]{: width="80%"}
...
#### Moscú
![Persepolis_MarjaneSatrapi_1-08][Persepolis_MarjaneSatrapi_1-08]{: width="80%"}
...
#### Las ovejas
![Persepolis_MarjaneSatrapi_1-09][Persepolis_MarjaneSatrapi_1-09]{: width="80%"}
...
#### El viaje
![Persepolis_MarjaneSatrapi_2-01][Persepolis_MarjaneSatrapi_2-01]{: width="80%"}
...
#### Las F-14
![Persepolis_MarjaneSatrapi_2-02][Persepolis_MarjaneSatrapi_2-02]{: width="80%"}
...
#### Las joyas
![Persepolis_MarjaneSatrapi_2-03][Persepolis_MarjaneSatrapi_2-03]{: width="80%"}
...
#### La llave
![Persepolis_MarjaneSatrapi_2-04][Persepolis_MarjaneSatrapi_2-04]{: width="80%"}
...
#### El vino
![Persepolis_MarjaneSatrapi_2-05][Persepolis_MarjaneSatrapi_2-05]{: width="80%"}
...
#### El pasaporte
![Persepolis_MarjaneSatrapi_2-06][Persepolis_MarjaneSatrapi_2-06]{: width="80%"}
...
#### Kim Wilde
![Persepolis_MarjaneSatrapi_2-07][Persepolis_MarjaneSatrapi_2-07]{: width="80%"}
...
#### El sabbat
![Persepolis_MarjaneSatrapi_2-08][Persepolis_MarjaneSatrapi_2-08]{: width="80%"}
...
#### La dote
![Persepolis_MarjaneSatrapi_2-09][Persepolis_MarjaneSatrapi_2-09]{: width="80%"}
...
#### La sopa
![Persepolis_MarjaneSatrapi_3-01][Persepolis_MarjaneSatrapi_3-01]{: width="80%"}
...
#### El tirol
![Persepolis_MarjaneSatrapi_3-02][Persepolis_MarjaneSatrapi_3-02]{: width="80%"}
...
#### Las pastas
![Persepolis_MarjaneSatrapi_3-03][Persepolis_MarjaneSatrapi_3-03]{: width="80%"}
...
#### La píldora
![Persepolis_MarjaneSatrapi_3-04][Persepolis_MarjaneSatrapi_3-04]{: width="80%"}
...
#### La legumbre
![Persepolis_MarjaneSatrapi_3-05][Persepolis_MarjaneSatrapi_3-05]{: width="80%"}
...
#### El caballo
![Persepolis_MarjaneSatrapi_3-06][Persepolis_MarjaneSatrapi_3-06]{: width="80%"}
...
#### Escondite
![Persepolis_MarjaneSatrapi_3-07][Persepolis_MarjaneSatrapi_3-07]{: width="80%"}
...
#### Love story
![Persepolis_MarjaneSatrapi_3-08][Persepolis_MarjaneSatrapi_3-08]{: width="80%"}
...
#### El cruasán
![Persepolis_MarjaneSatrapi_3-09][Persepolis_MarjaneSatrapi_3-09]{: width="80%"}
...
#### El retorno
![Persepolis_MarjaneSatrapi_4-01][Persepolis_MarjaneSatrapi_4-01]{: width="80%"}

Marjane en el aeropuerto después de cuatro años viviendo en Viena retorna a Teherán, y siente/nota el aire represivo, se encuentra con los padres y regresa al hogar. Al día siguiente hace un recuento de sus pertenencias y va a charlar con su madre que ya la trata como adulta. Al salir debe acostumbrarse al pañuelo, y a las sórdidas decoración y calles de mártires. De regreso en casa en la noche, el papá que es ingeniero regresa, comen y charlan, la madre tiene un discurso derrotista. El padre interviene y hablan, del gran montaje que es esa guerra para destruir los ejercitos de Irán e Irak con Occidente proveyendo armas, cuenta los particularmente atroces meses precedentes al alto al fuego/*armisticio*, de los rebeldes armados *Muyahidin* opuestos al régimen islámico y los dirigentes integristas, del ataque entrando por Irak, y que la mayoría mueren o son capturados y ejecutados. El padre trata de ser optimista y dice que hay que mirar hacia adelante y reconstruir, pero parecía igual de hastiado que la madre, Marjane decide no contar sobre su vida y problemillas en Austria.

#### El chiste
![Persepolis_MarjaneSatrapi_4-02][Persepolis_MarjaneSatrapi_4-02]{: width="80%"}

Marjane recibe las visitas de todos, pasando por familiares, la abuela, amigas, recuerda a antiguos amigos, contacta al mutilado Kia; lo visita, charlan, le cuenta el chiste, Marjane aprende, Kia se va a EEUU, pierden el contacto.

#### El esquí
![Persepolis_MarjaneSatrapi_4-03][Persepolis_MarjaneSatrapi_4-03]{: width="80%"}

Marjane se encuentra desasosegada, empieza a recibir consejos de allegados, pero manifiesta que aunque ellos han pasado por una guerra, estan juntos, ella no la ha pasado bien y quiere que se compadezcan y la entiendan, y en general estaba depresiva, veía la serie japonesa "Oshin", la invitan a esquiar, se da cuenta de que detrás del aspecto de mujeres modernas sus amigas eran unas autenticas tradicionalistas, eran agresivas por estar saturadas de hormonas y frustraciones, y para ellas Marjane se había convertido en una occidental decadente, vuelve más deprimida, empieza a visitar psicólogos, hasta que uno la remite a psiquiatría para medicación, las pastillas resultan eficaces durante el efecto, pero luego la angustia y depresión retornaban, hasta el punto que intenta suicidarse, después del episodio el terapeuta le dice que aunque no es creyente solo le atribuye a intervención divina su supervivencia, Marjane decide que no es momento de morir y decide tomar las riendas, se transforma en una mujer a la última moda, y empieza a hacer deporte hasta convertirse en profesora de aerobic, resuelta a encaminarse a su nuevo destino.

#### El concurso
![Persepolis_MarjaneSatrapi_4-04][Persepolis_MarjaneSatrapi_4-04]{: width="80%"}

Recompuesta, consentida y con nuevo carro, Marjane encara su nuevo rumbo. En abril de 1989 en una fiesta de la amiga Roxana conoce a Reza, su futuro marido en dos años, son polos opuestos que se complementan, hablan de planes, de emigrar, se preparan para el concurso nacional para ingreso en la universidad, en junio de 1989 presentan los exámenes, con buena fortuna pasan, Marjane se prepara para el Test Ideológico, aprueba y se convierte en una universitaria admitida.

#### El maquillaje
![Persepolis_MarjaneSatrapi_4-05][Persepolis_MarjaneSatrapi_4-05]{: width="80%"}

Ya como pareja, empiezan las quejas mutuas, con respecto al maquillaje una vez Marjane acude a una cita maquillada, pero al ver una patrulla de la revolución, para salvarse acusa a un indigente, se lo llevan, llega Reza, se habla de las costumbres morales y valores de la república en cuanto al tránsito de parejas, al final por primera vez la abuela la reprende por el acto de acusar a un inocente.
